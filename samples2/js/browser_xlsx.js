...
(function() {
  var START_DAY, alphabet, col2num, convertDate, escapeXmlMarkup, getAttr, numFmts, ref2cr, typeOf, unescapeXmlMarkup;
  ...
  exports.decode = function(file) {
    var cell, columns, contentTypes, f, i, id, index, j, k, m, merges, processTime, props, result, s, sharedStrings, styles, t, w, worksheets, xlRels, zip, zipTime, _i, _j, _len, _ref, _ref1;
    zip = new JSZip();
    contentTypes = [[], []];
    props = [];
    xlRels = [];
    ...
    if (s) {
      ...
      i = s.length;
      while (--i) {
        sharedStrings[i - 1] = unescapeXmlMarkup(s[i].substring(0, s[i].indexOf("</t>")));
      }
    }
