...
(function() {
  var START_DAY, alphabet, convertDate, getAttr, numFmts, typeOf;
  ...
  exports.decode = function(file) {
    var cell, columns, contentTypes, f, i, id, index, j, k, processTime, props, result, s, sharedStrings, styles, t, w, worksheets, xlRels, zip, zipTime, _i, _len, _ref;
    zip = new JSZip();
    contentTypes = [[], []];
    props = [];
    xlRels = [];
