...
(function() {
  ...
  exports.encode = function(file) {
    var contentTypes, days, docProps, i, id, index, j, k, l, processTime, props, result, s, sharedStrings, t, w, worksheet, worksheets, xl, xlRels, xlWorksheets, zip, zipTime;
    zip = new JSZip();
    contentTypes = [[], []];
    props = [];
    xlRels = [];
