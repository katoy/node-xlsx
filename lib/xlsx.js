...
exports.decode = function(file) {
  var contentTypes, i, id, index, j, k, l, processTime, props, result, s, sharedStrings, t, w, worksheets, xlRels, zip, zipTime;
  zip = new JSZip();
  contentTypes = [[], []];
  props = [];
  xlRels = [];
...
exports.encode = function(file) {
  var contentTypes, docProps, i, id, index, j, k, l, processTime, props, result, s, sharedStrings, t, w, worksheet, worksheets, xl, xlRels, xlWorksheets, zip, zipTime;
  zip = new JSZip();
  contentTypes = [[], []];
  props = [];
  xlRels = [];
